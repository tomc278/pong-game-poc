  ...
  execute: configuration => {
    ...
    const Game = {
      ...
      endGameMenu: function(text) {
        ...
        Pong.context.fillStyle = gameOverTextColor;
      ...
      menu: function() {
        ...
        // Change the canvas color;
        // GAME START TEXT COLOUR
        this.context.fillStyle = gameStartTextColor;
      ...
      draw: function() {
        ...
        // GAME PADDLES AND BALL COLOUR
        this.context.fillStyle = paddlesAndBallColor;
        ...
        // GAME NET LINE (MIDDLE) COLOUR
        this.context.strokeStyle = netColor;
        this.context.stroke();
